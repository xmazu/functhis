/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 591618f629c1ce0f524d020a02b21293)
...
interface __BaseEnv_Env {
	...
	LOADER: WorkerLoader;
	AI: Ai;
	CONSOLE_URL: "https://functhis.now" | "http://localhost:3001";
	MCP_RESOURCE: "https://mcp.functhis.now" | "http://localhost:3003";
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		HYPERDRIVE: Hyperdrive;
		ANALYTICS: AnalyticsEngineDataset;
		FUNCTHIS_SECRETS_KEY: SecretsStoreSecret;
		LOADER: WorkerLoader;
		AI: Ai;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONSOLE_URL" | "MCP_RESOURCE" | "FUNCTHIS_SECRETS_KEY">> {}
}
