...
export const Card = ({
  ...
  const defaultProps = {
    className: cn(
      'bg-card text-card-foreground relative flex flex-col rounded-lg border',
      className
    ),
    'data-slot': 'card',
  };
...
export const CardHeader = ({
  ...
  const defaultProps = {
    className: cn(
      'grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 p-4 in-[[data-slot=card]:has(>[data-slot=card-panel])]:pb-3 has-data-[slot=card-action]:grid-cols-[1fr_auto]',
      className
    ),
...
export const CardTitle = ({
  ...
  const defaultProps = {
    className: cn(
      'font-heading text-[length:var(--app-font-size-ui,12px)] leading-none font-medium',
      className
    ),
...
export const CardDescription = ({
  ...
  const defaultProps = {
    className: cn(
      'text-muted-foreground text-[length:var(--app-font-size-ui,12px)]',
      className
    ),
...
export const CardPanel = ({
  ...
  const defaultProps = {
    className: cn(
      'flex-1 p-4 in-[[data-slot=card]:has(>[data-slot=card-footer]:not(.border-t))]:pb-0 in-[[data-slot=card]:has(>[data-slot=card-header]:not(.border-b))]:pt-0',
      className
    ),
